...
export const action = async ({ request }) => {
  ...
  try {
    ...
    return redirect(
      `/exploreCollections/${collectionId}/exploreResearchPapers/${researchPaperId}`
    );
  } catch (error) {
    ...
    <div className="create-collections">
      <div className="wrapper">
        <div className="create-collections-btn-wrapper">
          ...
          >
            Go back to Explore Research Papers Page
          </Link>
        </div>
...
export default ExploreCreateComments;
